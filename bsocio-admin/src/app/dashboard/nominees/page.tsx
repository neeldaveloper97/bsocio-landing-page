        ...
        <div className="content-section active">
            ...
            <div className="section-header-with-btn">
                <div className="section-intro">
                    <h1>Nominees</h1>
                    <p>Manage award nominees and voting</p>
                </div>
            ...
            <div className="stats-cards-grid">
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-value">389</div>
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-value">125,678</div>
                        ...
                        <tbody>
                            {nominees.map((nominee) => (
                                <tr key={nominee.id}>
                                    ...
                                    <td>{nominee.votes.toLocaleString()}</td>
                                    <td>{getStatusBadge(nominee.status)}</td>
                                    <td>
                    ...
                    <div className="modal-content">
                        ...
                        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div className="form-group">
                                ...
                                <input type="text" id="nomineeName" className="form-input" placeholder="Enter nominee name" />
                            </div>
                            <div className="form-row">
                                <div className="form-group">
                                    <label htmlFor="award">Award</label>
                                    <select id="award" className="form-select">
                            ...
                            <div className="form-group">
                                ...
                                <textarea id="bio" className="form-textarea" placeholder="Enter nominee biography..." rows={4}></textarea>
                            </div>
