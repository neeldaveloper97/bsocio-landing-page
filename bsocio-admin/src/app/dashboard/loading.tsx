/**
 * ============================================
 * Dashboard Loading State - Mobile Optimized
 * ============================================
 * NO animations = lower TBT on mobile devices
 * Solid colors instead of pulse animations
 * ============================================
 */
...
export default function DashboardLoading() {
  return (
    <div className="page-content" aria-label="Loading dashboard...">
      ...
      {/* Activity section */}
      <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-6 mt-6">
