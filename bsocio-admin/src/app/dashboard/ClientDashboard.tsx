...
import React, { useMemo, useCallback, memo, useDeferredValue, useState } from "react";
...
const ActivityItem = memo(function ActivityItem({ activity, formatRelativeTime, formatFullDateTime }: ActivityItemProps) {
    return (
        <div 
            className="flex items-start gap-4 p-5 border-b border-gray-200 last:border-b-0 w-full transition-colors hover:bg-gray-50 max-md:p-4 max-md:gap-3"
        >
            ...
            <span 
                className="font-sans font-medium text-xs leading-4 text-gray-400 whitespace-nowrap shrink-0"
        ...
        <div className="page-content">
            ...
            <div className="page-header-row">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="font-sans font-normal text-base leading-6 text-gray-500 m-0">
